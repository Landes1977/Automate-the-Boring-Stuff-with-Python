...
# in random order, along with the answer.
...
# Generates n number (default 35) of quiz files.
for quizNum in range(int(students)):
...
for questionNum in range(50):
	...
	# Write the question and swaer options to the quiz file.
